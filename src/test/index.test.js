...
describe('App', () => {
    ...
    test('Test Login success', () => {
        ...
        wrapper
            .find('Login input[name="username"]')
            .simulate('change', { target: { value: 'test', name: 'username' } })
        wrapper
    ...
    test('Create comment logged user', () => {
        ...
        expect(
            wrapper.find('CommentsBlock textarea').props().disabled
        ).toBeFalsy()
        expect(
            wrapper.find('CommentsBlock button[type="submit"]').props().disabled
        ).toBeFalsy()
    ...
    test('Render comments with remove button', () => {
        ...
        expect(wrapper.find('CommentsBlock .Comment').length).toEqual(2)
        expect(
            wrapper.find('CommentsBlock FontAwesomeIcon[icon="trash"]').length
        ).toEqual(1)
    })
})
